    ...
    def update(self):
        ...
        if(wall_style==2):
            if self.tick%10==0:
                ...
                wall.rot_vel-=0.4
                color_min=30
                wall.color=(color_min+random.randrange(color_min,255),color_min+random.randrange(color_min,255),color_min+random.randrange(color_min,255))
                self.walls.append(wall)
